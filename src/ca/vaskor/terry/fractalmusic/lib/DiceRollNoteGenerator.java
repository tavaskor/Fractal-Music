...
public abstract class DiceRollNoteGenerator implements NoteGenerator {
    public DiceRollNoteGenerator(
            NoteRangeRestrictor restrictor, int numPitchDice, int numDiceSides, 
            int numLengthDice, int numLengthSides, java.util.Random randGen
            ) {
    ...
    public DiceRollNoteGenerator(NoteRangeRestrictor restrictor,
            List<? extends Integer> numSidesPerPitchDice, 
            List<? extends Integer> numSidesPerLengthDice, 
