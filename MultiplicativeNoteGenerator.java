class MultiplicativeNoteGenerator extends DiceRollNoteGenerator {
	...
	private static int getNumLengthDice(NoteRangeRestrictor nrr) throws InvalidDataSpread {
	...
	private static void checkValueSpread(int pitchDiff, String valuename) throws InvalidDataSpread {
	...
	public MultiplicativeNoteGenerator(NoteRangeRestrictor nrr, long randomSeed) throws InvalidDataSpread {
